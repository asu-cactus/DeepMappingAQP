...
python datagen/datagen.py -s 100000000 -x data/catalog_returns/sample.csv -y data/catalog_returns/sample.json -o data/catalog_returns/dataset_sum.csv --scale 1
